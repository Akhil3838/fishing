          ...
          <div className="row">
            ...
            <div className="col-md-6 col-lg-4">
              <div className="contact-box cb3">
                ...
                <h5>Address</h5>
                <small>
                  First floor, KHRA BHAWAN, opp. biolab, Near old bustand
                  Payyanur, Kannur [dist.], Kerala, PIN-670307
                </small>
              </div>
            </div>
          </div>
            ...
            <div className="col-md-6">
              <div className="ci-info">
                ...
                <p className="sec_desc">
                  At <strong>Scaless</strong>, we are passionate about bringing
                  you the best fishing gear and accessories to make every catch
                  a memorable one. Whether you are an experienced angler or just
                  starting out, our team is here to help you find the right
                  equipment for your adventures. Have questions, feedback, or
                  special requests? Reach out to us and we are always ready to
                  assist fellow fishing enthusiasts.
                </p>
              </div>
            </div>
