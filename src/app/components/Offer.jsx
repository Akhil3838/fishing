      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-6 col-md-12">
            <div className="discount-product overlay-anim">
                  ...
                  <span className="price">
                    ...
                    <ins>
                      <span className="woocommerce-Price-amount amount">
                        ...
                        {products[0]?.sku_new[0]?.special_price}
                      </span>
                    </ins>
                  </span>
                </div>
              ...
              <div className="ds-thumb">
                <a href={`/productDetails/${products[0]?.slug}`}>
                  {" "}
                  <img
                    src={products[0]?.icon}
                    alt="image"
          ...
          <div className="col-lg-3 col-md-6 ">
            <div className="product-item-2 text-center">
              <div className="product-thumb">
                <a href={`/productDetails/${products[1]?.slug}`}>
                  {" "}
                  <img
                    src={products[1]?.icon}
                    alt="image"
                  ...
                  <span className="price">
                    ...
                    <ins>
                      <span className="woocommerce-Price-amount amount">
                        ...
                        {products[1]?.sku_new[0]?.special_price}
                      </span>
                    </ins>
                  </span>
                </div>
          ...
          <div className="col-lg-3 col-md-6">
            <div className="product-item-2 text-center">
              <div className="product-thumb">
                <a href={`/productDetails/${products[2]?.slug}`}>
                  {" "}
                  <img
                    src={products[2]?.icon}
                    alt="image"
                  ...
                  <span className="price">
                    ...
                    <ins>
                      <span className="woocommerce-Price-amount amount">
                        ...
                        {products[2]?.sku_new[0]?.special_price}
                      </span>
                    </ins>
                  </span>
                </div>
