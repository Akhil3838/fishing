      ...
      <div className="single-slide bg-img d-flex align-items-center" style={{
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-12">
                  <div className="slider-content">
                    <h5 className="sub-title animated">{banner?.[3]?.sub_text}<span></span></h5>
...
<div
  ...
  >
   ...
   {/* Slide 6 */}
{  banner?.[5] &&              <div className="single-slide bg-img d-flex align-items-center" style={{
            height: '80vh',
            backgroundImage: `url(${banner?.[4]?.image_url})`,
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-12">
                  <div className="slider-content">
                    <h5 className="sub-title animated">{banner?.[4]?.sub_text}<span></span></h5>
                    <h2 className="animated">{banner?.[4]?.main_text}</h2>
                    <a  href="/shop/all"  className="fishto-btn sb2 animated">Shop Now <i className="nss-long-arrow-right1"></i></a> 
                  </div>
                </div>
