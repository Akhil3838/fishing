...
export default function FishingStoreHero({
  slides = [
    ...
    { src: "https://img.freepik.com/free-photo/tackle-grass_1161-340.jpg?t=st=1772426923~exp=1772430523~hmac=7272b8e20c8469380a86460a31181bb6a86392b269f619caeeb8fd66d9940c46&w=1480", title: "Trusted by Anglers", description: "Quality equipment for real fishermen." },
  ],
  autoPlay = true,
  interval = 4000,
  className = ""
