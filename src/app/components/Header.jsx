            ...
            <div className="col-lg-12">
              <nav className="navbar navbar-expand-lg">
                ...
                <div className="collapse navbar-collapse">
                  <div
                    className="d-none d-lg-flex justify-content-center w-100 position-relative"
                                  ...
                                  >
                                    ...
                                    <div className="product-details">
                                      ...
                                      <div className="product-category">
                                        <span>
                                          In {item.category?.category_name}
                                        </span>
                                      </div>
                                    </div>
                                  </Link>
  ...
  {mounted && (
    ...
    ></div>
                  ...
                  {token ? (
                    ...
                    <Link href="/login" className="btn-cart">
                      <i className="nss-user1"></i>
                    </Link>
                  )}
        ...
        <div className="container small_search">
          <div
            className="d-block d-lg-none justify-content-center w-100 position-relative"
            ref={searchDropdownRef}
          >
            <div
              className="search-container"
            ...
            <div className="position-relative">
              <div
                style={{
                  height: "80px",
                  background:
                    "linear-gradient(90deg,rgb(23, 40, 118) 0%, #764ba2 100%)",
                }}
              ></div>
              <div className="position-absolute top-100 start-50 translate-middle">
                <div className="bg-white p-1 rounded-circle shadow">
                  <div
                    className="bg-light p-3 rounded-circle d-flex justify-content-center align-items-center"
                    style={{
                      width: "80px",
                      height: "80px",
                      background:
                  ...
                  >
                    <i
                      ...
                      style={{ fontSize: "2.5rem", color: "rgb(23, 40, 118)" }}
                    ></i>
                  </div>
                </div>
              </div>
            ...
            <div className="modal-body text-center pt-5 pb-4 px-4">
              ...
              <div className="d-flex justify-content-center gap-3">
                ...
                <button
                  ...
                  className="btn btn-outline-danger px-4 py-2 rounded-pill d-flex align-items-center"
                  style={{
                    borderWidth: "2px",
                    fontWeight: "500",
                  }}
