...
if (!token) {
  ...
  const fetchPrice = async (selected) => {
    try {
      ...
      const hasColor = Object.keys(selected).some(
        (attr) => attr.toLowerCase() === "color",
      );
      ...
      <div className="row" style={{ paddingTop: "100px" }}>
        <div className="col-lg-6 col-md-6">
          <div
            ...
            style={{ paddingLeft: "75px", position: "relative" }}
          >
            <button
              onClick={prevSlide}
                  ...
                  <img
                    ...
                    style={{
                      transformOrigin: isLargeScreen
                        ...
                        : "center",
                      transform:
                        isLargeScreen && zoomActive ? "scale(2)" : "scale(1)",
                    }}
                  />
                </div>
              </div>
          ...
          <div className="product-decp">
                        ...
                        if (
                          ...
                          return (
                            <div
                              ...
                              onClick={() =>
                                handleVariantSelect(attribute, option.id)
                              }
                            >
                              {/* Image Circle */}
                              <div
                        ...
                        return (
                          <button
                            ...
                            style={{
                              ...
                              marginBottom: "5px",
                              opacity:
                                option.stock === "out-of-stock" ? "0.4" : "1",
                            }}
                          >
                    ...
                    >
                      ...
                      >
                        ...
                        <p style={{ fontSize: "14px", color: "#666" }}>
                          Enter your mobile number and we’ll notify you when
                          it’s back in stock.
                        </p>
            ...
            {stockStatus === "in-stock" && (
              <>
                <div className="d-flex flex-row align-items-center gap-3 flex-wrap">
                  ...
                  <div className="listing-meta my-3">
                    <a
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        handleAddToCart(product.id, skuId, quantity);
                      }}
                    >
                      Add To Cart
                    </a>
                ...
                <button
                  ...
                  onClick={() => handleBuyNow(product.id, skuId, quantity)}
                >
            ...
            <div className="d-flex justify-content-between align-items-center flex-wrap mb-3">
              ...
              <div className="d-flex align-items-center gap-2 mt-2 mt-md-0">
                ...
                <Link href={""}>
                  {" "}
                  <h6 className="mb-0 share-text">Share Products</h6>
                </Link>
              </div>
            </div>
